...
public class ExampleUnitTest {
    ...
    public void ReadJYBuffer() {
        ...
        JYBufferReader bufferReader = new JYBufferReader();
        ByteArrayInputStream bis = new ByteArrayInputStream(ReadByteArray(a));

        Sample smpl = bufferReader.ReadSample(bis);
        assertNull(smpl);

        bis = new ByteArrayInputStream(ReadByteArray(b));
        smpl = bufferReader.ReadSample(bis);
        assertNotNull(smpl);
